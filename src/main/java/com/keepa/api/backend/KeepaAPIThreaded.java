...
public final class KeepaAPIThreaded {
	/**
	 ...
	 */
	public KeepaAPIThreaded(String key, int threads) {
	 ...
	 */
	public KeepaAPIThreaded(String key, ExecutorService executorRetry, ExecutorService executorDeferred) {
		this.accessKey = key;
	 ...
	 * @param key Your private API Access Token
	 */
	public KeepaAPIThreaded(String key) {
		this(key, 4);
	}
